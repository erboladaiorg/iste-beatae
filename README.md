...
[![Coverage Status](https://coveralls.io/repos/github/erboladaiorg/iste-beatae/badge.svg)](https://coveralls.io/github/erboladaiorg/iste-beatae)
[![ci](https://github.com/erboladaiorg/iste-beatae/actions/workflows/ci.yml/badge.svg)](https://github.com/erboladaiorg/iste-beatae/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@erboladaiorg/iste-beatae.svg)](https://www.npmjs.com/package/@erboladaiorg/iste-beatae)
[![NPM Downloads](https://img.shields.io/npm/dm/@erboladaiorg/iste-beatae.svg)](http://npm-stat.com/charts.html?package=@erboladaiorg/iste-beatae)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@erboladaiorg/iste-beatae)](https://www.jsdelivr.com/package/npm/@erboladaiorg/iste-beatae)
...
```
npm install @erboladaiorg/iste-beatae
```
...
import { supportTransform } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { support3DTransform } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@erboladaiorg/iste-beatae";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/erboladaiorg/iste-beatae/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@erboladaiorg/iste-beatae";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@erboladaiorg/iste-beatae";
...
```js
// Example
import on from "@erboladaiorg/iste-beatae/src/event/on";
import addClass from "@erboladaiorg/iste-beatae/src/class/addClass";
import getElementById from "@erboladaiorg/iste-beatae/src/selectors/getElementById";
import mouseclickEvent from "@erboladaiorg/iste-beatae/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/erboladaiorg/iste-beatae/blob/master/LICENSE)
